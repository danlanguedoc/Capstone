...
- Strips the country name from the location column

```{r eq_read_example, message = FALSE}
filename <- system.file("extdata/earthquakes.tsv.gz", package = "Capstone")
